...
export const API_SPEC = Object.freeze({
  rootMethods: {
    ...
    rate: { action: 'playbackRate', type: 'command_value', args: ['rate', 'targetOrId', 'key'] },
    playbackRate: { action: 'playbackRate', type: 'command_value', args: ['rate', 'targetOrId', 'key'] },
    speed: { action: 'playbackRate', type: 'command_value', args: ['rate', 'targetOrId', 'key'] },
