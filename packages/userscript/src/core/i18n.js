export const I18N = {
  vi: {
    ...
    denyBtn: 'Từ chối',
    allowBtn: 'Đồng ý',
    allowAllBtn: 'Đồng ý tất cả',
    allowSessionBtn: 'Cho phép toàn phiên',
    denyAllBtn: 'Từ chối tất cả',
    blockSessionBtn: 'Chặn toàn bộ phiên',
  ...
  en: {
    ...
    allowSessionBtn: 'Allow for this session',
    denyAllBtn: 'Deny All',
    blockSessionBtn: 'Block this session',
