export const I18N = {
  vi: {
    ...
    allowAllBtn: 'Cho phép tất cả',
    denyAllBtn: 'Từ chối tất cả',
    alwaysAllowAllBtn: 'Luôn cho phép tất cả',
    allowSessionBtn: 'Cho phép tất cả cho phiên hiện tại',
    blockSessionBtn: 'Từ chối tất cả cho phiên hiện tại',
    alwaysDenyAllBtn: 'Luôn từ chối tất cả',
    tableColDomain: 'Trang yêu cầu',
    tableColAction: 'Hành động',
    dialogTableDesc: 'Các iframe sau đang yêu cầu quyền điều khiển media qua SRemote:',
  ...
  en: {
    ...
    denyAllBtn: 'Deny All',
    alwaysAllowAllBtn: 'Always Allow All',
    allowSessionBtn: 'Allow all for this session',
    blockSessionBtn: 'Block all for this session',
    alwaysDenyAllBtn: 'Always Deny All',
    tableColDomain: 'Requesting Frame',
    tableColAction: 'Actions',
    dialogTableDesc: 'The following iframes are requesting media control permissions:',
